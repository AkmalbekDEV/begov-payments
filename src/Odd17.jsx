...
const Odd17 = () => {
    ...
    const getData = async () => {
        try {
            const response = await axios.get('https://681c54859b2ef3a7.mokky.dev/Odd_17')
    ...
    const handleStatus = async (id, status) => {
        try {
            const response = await axios.patch(`https://681c54859b2ef3a7.mokky.dev/Odd_17/${id}`, {
                status: status,
            })
    ...
    const handleAdd = (e) => {
        ...
        const postData = async () => {
            try {
                const response = await axios.post('https://681c54859b2ef3a7.mokky.dev/Odd_17', {
                    name,
                    status: false,
                })
    ...
    const handleDelete = async (id) => {
        try {
            const response = await axios.delete(`https://681c54859b2ef3a7.mokky.dev/Odd_17/${id}`)
